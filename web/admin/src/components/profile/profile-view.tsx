...
export function ProfileView({ user, profile, isAppAdmin }: ProfileViewProps) {
      ...
      <CardHeader className="flex flex-row items-center gap-4">
        <Avatar className="h-12 w-12">
          <AvatarImage
            ...
            alt={formState.full_name || user.email || ""}
          />
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-2 md:grid-cols-2">
          ...
          <InfoRow
            ...
            label="Role"
            value={isAppAdmin ? "App Admin" : "Member"}
          />
        </div>
        ...
        <p className="text-muted-foreground text-xs">
          Editing is enforced by backend authorization.
        </p>
      </CardContent>
    </Card>
  );
